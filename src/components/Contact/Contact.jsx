      ...
      <div className="container container__contact">
        <div className="contact_options">
          <article className='contact_option'>
            ...
            <h4>Email</h4>
            <h5>mr.sherry.793@gmail.com</h5>
            <a target='_blank' href="mailto:mr.sherry.793@gmail.com">Send a message</a>
          </article>
          <article className='contact_option'>
            <PiMessengerLogoBold className='contact_option-icon'/>
            <h4>Messenger</h4>
            <h5>Shehroz Baloch</h5>
            <a target='_blank' href="https://m.me/mshahroz.ashraf">Send a message</a>
          </article>
          <article className='contact_option'>
            <BsWhatsapp className='contact_option-icon'/>
            <h4>WhatsApp</h4>
            <h5>+92 307 4496244</h5>
            <a target='_blank' href="https://api.whatsapp.com/send?phone=03074496244">Send a message</a>
          </article>
        </div>
